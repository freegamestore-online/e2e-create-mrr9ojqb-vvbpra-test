...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mrr9ojqb-vvbpra-test",
        short_name: "Create Canary e2e-create-mrr9ojqb-vvbpra-test",
        description: "Create Canary e2e-create-mrr9ojqb-vvbpra-test — free forever",
        start_url: "/",
        display: "standalone",
